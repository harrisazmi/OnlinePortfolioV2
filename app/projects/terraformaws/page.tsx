    ...
    >
      <div ref={ref} className="max-w-3xl mx-auto p-6 lg:pt-0 space-y-6">
        ...
        <div className="relative w-full aspect-[325/202] mt-4 border-2 border-gray-110 rounded-3xl overflow-clip">
          <Image
            src={TerraformAWSPortfolio.projectImage}
            alt={TerraformAWSPortfolio.projectName}
            width={3000}
            height={2000}
            quality={100}
          />
        ...
        <h1 className="font-bold text-5xl">
          {TerraformAWSPortfolio.projectName}
        </h1>
        <p className="text-lg text-gray-140">
          {TerraformAWSPortfolio.overview}
        </p>
        ...
        <div>
          ...
          <p className="text-lg text-gray-140 py-2">
            {TerraformAWSPortfolio.solutionsHeader}
          </p>

          {TerraformAWSPortfolio.solutionsList.map((solution, index) => (
          ...
          <p className="text-lg text-gray-140 pt-2">
            {TerraformAWSPortfolio.solutionsConclusion}
          </p>
        </div>

        <TechStack
          title="Tech Stack (DevOps)"
          techStackTool={TerraformAWSPortfolio.techstack.devops}
        ></TechStack>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {TerraformAWSPortfolio.sections.featurenhighlights.items.map(
            (item, index) => (
              <div
                key={index}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {TerraformAWSPortfolio.sections.impactandoutcomes.items.map(
            (item, index) => (
              <div
                key={index}
                className="flex  flex-col gap-4 bg-gray-110  rounded-lg p-4"
